...
(
    ...
    electrocardiogram_id uuid
        constraint fkrkqthklxbynh2vlinvs6s31d0
    ...
    therapist_id         uuid
        constraint fkmea9c23feavo5cxw5je17xeij
            references doctors,
    vision_test_id       uuid
        constraint fkdmc28wsgevsevxq50xl4r9hb5
            references certificates
);
...
(
    ...
    id                         uuid not null
        primary key
        constraint fk1yhao56serhj4ubgkpwlxdxu9
            references certificates
);
...
(
    ...
    id         uuid not null
        primary key
        constraint fkkn1bnfses05oou7i9memvxt8p
            references certificates
);
